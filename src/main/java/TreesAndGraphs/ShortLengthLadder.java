...
// Java program to find length of the shortest chain transformation from source to target

import java.util.*;

class ShortLengthLadder {
    ...
    static int shortestChainLen(String start, String target, Set<String> D) {
        ...
        while (!Q.isEmpty()) {
            ...
            // it is being traversed so only the elements which were already present
            // in the queue before the start of this loop will be traversed for now
